...
import { viewCenterProfile } from '../../../Actions/Center/dashboard'
  ...
  return (
    <>
          ...
          <div className="profilebutton-box text-end">
              <Link to='/center/settings/myprofile/change-password' className='theme-btn text-none d-inline-block'>Change Password</Link>
              <Link to='/center/settings/editmyprofile' className='theme-btn text-none d-inline-block ms-2'>Edit My Profile</Link>
            </div>
                      ...
                      <div className="col-xl-8">
                        <div className="profileinfo profile-updated">
                          <div className="profile-img">
                            <img src={profileData?.profile ? profileImage : defaultimage} alt="ollato-img" />
                          </div>
